                                                        ...
                                                        <td>{{$product->Description}}</td>
                                                          <td>
                                                                ...
                                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                                    data-id="{{ $product->id }}" data-name_product="{{ $product->nameProduct }}"
                                                                    data-description="{{ $product->Description }}" data-toggle="modal" href="#exampleModal2"
                                                                    title="تعديل"><i class="las la-pen"></i></a>

                                                                <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                                     data-id="{{ $product->id }}" data-name_product="{{ $product->nameProduct }}" data-toggle="modal"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="products/update" method="post" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="nameProduct" id="nameProduct" type="text">
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="products/destroy" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="id" id="id" value="">
                                        <input class="form-control" name="nameProduct" id="nameProduct" type="text" readonly>
                                    </div>
                                    <div class="modal-footer">
...
<script src="{{URL::asset('assets/js/modal.js')}}"></script>
 ...
 <script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var nameProduct = button.data('name_product')
            var description = button.data('description')
            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #nameProduct').val(nameProduct);
